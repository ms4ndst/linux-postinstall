...
sudo zypper --non-interactive install --allow-vendor-change \
  xorg-x11-server xinit xauth xrandr xset xsetroot xrdb \
  i3 i3lock \
...
#     (pointsize 26, matching the Fedora script's own wordmark height of
#     21px pre-upscale, since both use the same font/technique and only
#     the text differs), alpha-thresholded to kill anti-aliasing, then
#     upscaled 8x with nearest-neighbor - the same hard-pixel-edge
#     technique Omarchy's own font produces, applied to different text in
#     a different font so nothing is copied, only the *look*. Reads
#     "OPENSUSE" here (the Fedora script's own copy of this same asset
#     reads "FEDORA" - regenerated with the identical recipe, not just
#     copied over and left saying the wrong distro). The bullet/entry/lock/progress bar are
...

B64EOF
...
# Border colors come from current-borders.conf (a copy of one of
# themes/*.conf, chosen via ~/.local/bin/polybar-theme.sh) rather than
# being set directly here - same "include a swappable file" pattern
# kitty.conf already uses for its own current.conf. Unlike kitty, i3 has
# no live-recolor IPC command for client.* (nothing equivalent to `kitty @
# set-colors`), so a theme switch triggers a plain `i3-msg reload` instead
# (already wired into polybar-theme.sh) to pick up the new file - safe and
# non-destructive, same reload used by $mod+shift+c below.
include current-borders.conf
